...
Function `autoplot` visualizes the smoothed components and the smoothing performance.
...
Function `autoplot` visualize the one-bin-ahead forecast components and the forecasting performance.
