...
- $\boldsymbol{\phi} = [\phi_1,\dots, \phi_I]^\top$ is the log seasonal component;
...
- $\mathbf{x}_1$ is the initial state at $\tau = 1$, and it is assumed to follow $\mathcal{N}(\mathbf{x}_0, \mathbf{V}_0)$.
